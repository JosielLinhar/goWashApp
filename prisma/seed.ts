...
async function seedDatabase() {
  try {
    ...
    // Nomes criativos para as Lavações
    const creativeNames = [
      "Lavação Vintage",
      "Corte & Estilo",
      "Barba & Navalha",
    ...
    // Endereços fictícios para as Lavações
    const addresses = [
      "Rua da Lavação, 123",
    ...
    // Criar 10 Lavações com nomes e endereços fictícios
    const washes = [];
    for (let i = 0; i < 10; i++) {
    ...
    console.error("Erro ao criar as Lavações:", error);
  }
}
